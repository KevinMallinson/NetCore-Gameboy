...
namespace UnitTests.CPUTests
{
    public class LDTests
    {
        ...
        public static void Method1(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        { 
        ...
        public static void Method2(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        { 
        ...
        public static void Method3(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        {
        ...
        public static void Method4(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        { 
        ...
        public static void Method5(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        { 
        ...
        [InlineData(0x0E, "LD A,(HL-)",  2, 8, "- - - -")]
        [InlineData(0x1E, "LD E,d8",     2, 8, "- - - -")]
        [InlineData(0x2E, "LD L,d8",     2, 8, "- - - -")]
        [InlineData(0x3E, "LD A,d8",     2, 8, "- - - -")]
        public static void Method6(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        { 
        ...
        public static void Method7(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        {
        ...
        public static void Method8(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        { 
        ...
        public static void Method9(ushort opcode, string mnemonic, int length, int cycles, string flags) 
        { 
